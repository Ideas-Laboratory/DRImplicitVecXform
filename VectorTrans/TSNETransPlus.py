...
from VectorTrans.VectorTransformPlus import VectorTransformPlus
from VectorTrans.DRTrans import DRTrans
from Derivative.TSNEDerivativePlus import TSNEDerivativePlus
from VectorTrans import Metric


class TSNETransPlus(DRTrans):
    ...
    def init_y(self, Y0, perplexity=30.0):
        ...
        if Y0 is None:
            ...
            Y = t_sne.fit_transform(self.X, max_iter=20000, early_exaggerate=False, y_init=Y0)
        self.Y = Y
